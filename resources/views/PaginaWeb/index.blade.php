...
<div id="fb-root"></div>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="{{url('/')}}"><img src="assets/img/logo_p.png" class="img-fluid"></a></h1>
...
<noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript">comments powered by Disqus.</a></noscript>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Constelarsana</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="">Mike-Mao92-Hache</a>
      </div>
    </div>
  </footer><!-- End Footer -->
